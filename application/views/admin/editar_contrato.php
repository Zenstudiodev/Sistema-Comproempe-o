        ...
        <div id="contrato">
            ...
            <section class="content">
                ...
                <div class="box box-primary">
                    ...
                    <!-- form start -->
                    <form role="form" action="<?php echo base_url() ?>Contrato/guardar_editar" method="post"
                          id="contrato_form"
                          name="contrato_form">
                        ...
                        <table class="table table-bordered">
							...
							foreach ($productos->result() as $producto)
							{
                                ...
                                <tr>
                                    ...
                                    <td>
                                        Q.<span class="avaluo_producto"><?php echo $producto->avaluo_comercial; ?></span>
                                    </td>
