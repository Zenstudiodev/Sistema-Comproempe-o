...
<script>
    ...
    $(function() {
        ...
        $.ajax({
            type: "GET",
            url: "<?php echo base_url()?>productos/cargar_productos_en_bodega"
            ...
            $("#jsGrid").jsGrid({
                ...
                controller: {
                    ...
                    updateItem: function(item) {
                        ...
                        return $.ajax({
                            type: "PUT",
                            url: "<?php echo base_url()?>productos/actualizar_producto_bodega",
                            data: item
                ...
                fields: [
                    ...
                    {name: "producto_id", type: "text", readOnly: true},
                    {name: "contrato_id", type: "number", readOnly: true},
                    {name: "tienda_actual", type: "number", readOnly: false},
