                                ...
                                <table class="table table-bordered table-hover">
                                    ...
                                    do {
                                        ...
                                        <tr>
                                            ...
                                            <?php
                                            // Loop apartados
                                            $apartados_dia = $ci->Caja_model->get_apartados_dia($fecha_inicio->format('Y-m-d'));
                                            ...
                                            <?php
                                            // Loop empeños
                                            $empenos_dia = $ci->Caja_model->get_empenos($fecha_inicio->format('Y-m-d'));
                                            $total_empenos_dia =0;
                                            //$numero_empenos =0;
                                            ...
                                            <?php
                                            // Loop desempeños
                                            $desempenos_dia = $ci->Caja_model->get_intereses_desempeno($fecha_inicio->format('Y-m-d'));
                                            ...
                                            <?php
                                            // Loop refrendos
                                            $refrendo_dia = $ci->Caja_model->get_intereses_refrendo($fecha_inicio->format('Y-m-d'));
                                            ...
                                            <?php
                                            // Loop gastos
                                            $gastos = $ci->Caja_model->get_otros_gastos($fecha_inicio->format('Y-m-d'));
                                            $total_gastos_dia =0;
                                            if($gastos){
