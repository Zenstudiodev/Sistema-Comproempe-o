            ...
            <form action="<?php echo base_url() ?>/contrato/guardar_factura_desempeno" method="post" id="desempeno_form">
                ...
                <div class="row invoice-info">
                    ...
                    <div class="col-sm-4 invoice-col">
						...
						<?php  diferencia_dias($contrato->fecha_pago); ?>
                    </div>
                    <!-- /.col -->
                </div>
                <!-- /.row -->
                ...
                <!-- Table row -->
                <div class="row">
                    <h3 class="box-title">Factura por desempeño</h3>
                    <div class="col-xs-12 table-responsive">
                        ...
                        <table class="table table-striped table-bordered">
                            ...
                            <tr>
                                <td>Sub total</td>
                                <td>
									<?php display_formato_dinero($total_factura); ?>
                                    <input type="hidden" name="sub_total"
                                           value="<?php display_formato_dinero($total_factura); ?>">
                                </td>
                            </tr>
                            <tr>
                                <td>Descuento</td>
                ...
                <input type="hidden" name="tipo" value="desenmpeno">
                        ...
                        <table class="table table-striped table-bordered">
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    ...
                                    <input type="hidden" name="total_en_letras_recibo_i" id="total_en_letras_recibo_i"
                                           value="">
                                </td>
                            </tr>
                            </tr>
...
<script>
    ...
    $(document).ready(function () {
        ...
        var subtotal = parseFloat(<?php display_formato_dinero($total_factura); ?>);
        ...
        //Recibo
        total_recibo = <?php echo $mutuo; ?>;
        //total_recibo = total_recibo + 1.00;
        total_recibo = parseFloat(total_recibo).toFixed(2);
        //console.log(total_recibo);
        total_en_letras_recibo = covertirNumLetras(total_recibo);
        //console.log(total_en_letras_recibo);
        $("#total_en_letras_recibo").html(total_en_letras_recibo);
        $("#total_en_letras_recibo_i").val(total_en_letras_recibo);
        // console.log(total_en_letras_recibo);
