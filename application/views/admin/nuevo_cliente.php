...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box box-primary">
            ...
            ?>
            <!-- form start -->
            <form role="form" action="<?php echo base_url()?>/cliente/Guardar" method="post">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <label>
                                <input type="radio" name="publicidad" class="minimal" value="Si" checked> Si
                            </label>
                            <label>
                                <input type="radio" name="publicidad" class="minimal" value="No"> No
                            </label>
                        </div>
                    </div>
