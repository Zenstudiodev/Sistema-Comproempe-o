        ...
        <div class="box">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    <input type="button" id="exportar_btn" onclick="tableToExcel('tienda_1', 'Contratos tienda 1')" value="Exportar a excel tienda 1">
                    <input type="button" id="exportar_btn" onclick="tableToExcel('tienda_2', 'Contratos tienda 2')" value="Exportar a excel tienda 2">
                    <input type="button" id="exportar_btn" onclick="tableToExcel('tienda_3', 'Contratos tienda 3')" value="Exportar a excel tienda 3">
                    <input type="button" id="exportar_btn" onclick="tableToExcel('tienda_4', 'Contratos tienda 4')" value="Exportar a excel tienda 4">
                    <input type="button" id="exportar_btn" onclick="tableToExcel('tienda_5', 'Contratos tienda 5')" value="Exportar a excel tienda 5">
                    <input type="button" id="exportar_btn" onclick="tableToExcel('tienda_6', 'Contratos tienda 5')" value="Exportar a excel tienda 6">
                </div>
                <!--<button onclick="exportTableToExcel('table', 'contratos')">Export Table Data To Excel File</button>-->
                <?php
                if (isset($from)) {
                    //fecha de inicio
                                                    ...
                                                    <div class="box-body">
                                                        <div class="col-md-12">
                                                            <div class="table-responsive">
                                                                ...
                                                                if ($contratos) {
                                                                    ?>
                                                                    <table class="table table-condensed table-bordered table-hover" id="tienda_1">
                                                                        <thead>
                                                                        <tr>
                                                                            <td># de contratos</td>
                                                                            <td>Tienda Id</td>
                                                    ...
                                                    <div class="box-body">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="table-responsive">
                                                                ...
                                                                if ($contratos) {
                                                                    ?>
                                                                    <table class="table table-condensed table-bordered table-hover" id="tienda_2">
                                                                        <thead>
                                                                        <tr>
                                                                            <td># de contratos</td>
                                                                            <td>Tienda Id</td>
                                                    ...
                                                    <div class="box-body">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="table-responsive">
                                                                ...
                                                                if ($contratos) {
                                                                    ?>
                                                                    <table class="table table-condensed table-bordered table-hover" id="tienda_3">
                                                                        <thead>
                                                                        <tr>
                                                                            <td># de contratos</td>
                                                                            <td>Tienda Id</td>
                                                    ...
                                                    <div class="box-body">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="table-responsive">
                                                                ...
                                                                if ($contratos) {
                                                                    ?>
                                                                    <table class="table table-condensed table-bordered table-hover" id="tienda_4">
                                                                        <thead>
                                                                        <tr>
                                                                            <td># de contratos</td>
                                                                            <td>Tienda Id</td>
                                                    ...
                                                    <div class="box-body">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="table-responsive">
                                                                ...
                                                                if ($contratos) {
                                                                    ?>
                                                                    <table class="table table-condensed table-bordered table-hover" id="tienda_5">
                                                                        <thead>
                                                                        <tr>
                                                                            <td># de contratos</td>
                                                                            <td>Tienda Id</td>
                                                    ...
                                                    <div class="box-body">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="table-responsive">
                                                                ...
                                                                if ($contratos) {
                                                                    ?>
                                                                    <table class="table table-condensed table-bordered table-hover" id="tienda_6">
                                                                        <thead>
                                                                        <tr>
                                                                            <td># de contratos</td>
                                                                            <td>Tienda Id</td>
