                ...
                <div class="row">
                    <div class="box box-solid">
                        ...
                        <div class="box-body">
                            ...
                            ?>
                            <p>
                                <input type="button" onclick="tableToExcel('table', 'W3C Example Table')"
                            ...
                            <table id="table" border="1">
                                            ...
                                            <div class="table-responsive">
                                                ...
                                                <table class="table table-bordered table-hover">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            Q.<?php echo display_formato_dinero($Audio->avaluo_ce) ?></td>
                                                        <td>
                                                            Q.<?php echo display_formato_dinero($Audio->avaluo_c) ?></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            Q.<?php echo display_formato_dinero($Camaras->avaluo_ce) ?></td>
                                                        <td>
                                                            Q.<?php echo display_formato_dinero($Camaras->avaluo_c) ?></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            Q.<?php echo display_formato_dinero($Celulares->avaluo_ce) ?></td>
                                                        <td>
                                                            Q.<?php echo display_formato_dinero($Celulares->avaluo_c) ?></td>
                                                        <td>
                                                            Q.<?php echo display_formato_dinero($Celulares->mutuo) ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Computadoras Laptops y Tablets</td>
                                                        <td><?php echo $computadoras_laptops_tablets->numero ?></td>
                                                        <td>
                                                            Q.<?php echo display_formato_dinero($computadoras_laptops_tablets->avaluo_ce) ?></td>
                                                        <td>
                                                            Q.<?php echo display_formato_dinero($computadoras_laptops_tablets->avaluo_c) ?></td>
                                                        <td>
                                                            Q.<?php echo display_formato_dinero($computadoras_laptops_tablets->mutuo) ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Deportes</td>
                                                        <td><?php echo $deportes->numero ?></td>
                                                        <td>
                                                            Q.<?php echo display_formato_dinero($deportes->avaluo_ce) ?></td>
                                                        <td>
                                                            Q.<?php echo display_formato_dinero($deportes->avaluo_c) ?></td>
                                                        <td>
                                                            Q.<?php echo display_formato_dinero($deportes->mutuo) ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Electrodomésticos</td>
                                                        <td><?php echo $electrodomesticos->numero ?></td>
                                                        <td>
                                                            Q.<?php echo display_formato_dinero($electrodomesticos->avaluo_ce) ?></td>
                                                        <td>
                                                            Q.<?php echo display_formato_dinero($electrodomesticos->avaluo_c) ?></td>
                                                        <td>
                                                            Q.<?php echo display_formato_dinero($electrodomesticos->mutuo) ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Herramientas</td>
                                                        <td><?php echo $herramientas->numero ?></td>
                                                        <td>
                                                            Q.<?php echo display_formato_dinero($herramientas->avaluo_ce) ?></td>
                                                        <td>
                                                            Q.<?php echo display_formato_dinero($herramientas->avaluo_c) ?></td>
                                                        <td>
                                                            Q.<?php echo display_formato_dinero($herramientas->mutuo) ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Hogar</td>
                                                        <td><?php echo $hogar->numero ?></td>
                                                        <td>
                                                            Q.<?php echo display_formato_dinero($hogar->avaluo_ce) ?></td>
                                                        <td>
                                                            Q.<?php echo display_formato_dinero($hogar->avaluo_c) ?></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            Q.<?php echo display_formato_dinero($instrumentos_musicales->avaluo_ce) ?></td>
                                                        <td>
                                                            Q.<?php echo display_formato_dinero($instrumentos_musicales->avaluo_c) ?></td>
                                                        <td>
                                                            Q.<?php echo display_formato_dinero($instrumentos_musicales->mutuo) ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Joyería</td>
                                                        <td><?php echo $joyeria->numero ?></td>
                                                        <td>
                                                            Q.<?php echo display_formato_dinero($joyeria->avaluo_ce) ?></td>
                                                        <td>
                                                            Q.<?php echo display_formato_dinero($joyeria->avaluo_c) ?></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            Q.<?php echo display_formato_dinero($line_blanca->avaluo_ce) ?></td>
                                                        <td>
                                                            Q.<?php echo display_formato_dinero($line_blanca->avaluo_c) ?></td>
                                                        <td>
                                                            Q.<?php echo display_formato_dinero($line_blanca->mutuo) ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Motocicletas y Automóviles</td>
                                                        <td><?php echo $motocicletas_automoviles->numero ?></td>
                                                        <td>
                                                            Q.<?php echo display_formato_dinero($motocicletas_automoviles->avaluo_ce) ?></td>
                                                        <td>
                                                            Q.<?php echo display_formato_dinero($motocicletas_automoviles->avaluo_c) ?></td>
                                                        <td>
                                                            Q.<?php echo display_formato_dinero($motocicletas_automoviles->mutuo) ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Salud y belleza</td>
                                                        <td><?php echo $salud_belleza->numero ?></td>
                                                        <td>
                                                            Q.<?php echo display_formato_dinero($salud_belleza->avaluo_ce) ?></td>
                                                        <td>
                                                            Q.<?php echo display_formato_dinero($salud_belleza->avaluo_c) ?></td>
                                                        <td>
                                                            Q.<?php echo display_formato_dinero($salud_belleza->mutuo) ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Video</td>
                                                        <td><?php echo $video->numero ?></td>
                                                        <td>
                                                            Q.<?php echo display_formato_dinero($video->avaluo_ce) ?></td>
                                                        <td>
                                                            Q.<?php echo display_formato_dinero($video->avaluo_c) ?></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            Q.<?php echo display_formato_dinero($videojuegos->avaluo_ce) ?></td>
                                                        <td>
                                                            Q.<?php echo display_formato_dinero($videojuegos->avaluo_c) ?></td>
                                                        <td>
                                                            Q.<?php echo display_formato_dinero($videojuegos->mutuo) ?></td>
                                                    </tr>
                                                </table>
                                                <?php } ?>
                                        ...
                                        <div class="row">
                                            ...
                                            <table class="table table-bordered table-hover">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        Q.<?php echo display_formato_dinero($total_Audio->avaluo_ce) ?></td>
                                                    <td>
                                                        Q.<?php echo display_formato_dinero($total_Audio->avaluo_c) ?></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        Q.<?php echo display_formato_dinero($total_Camaras->avaluo_ce) ?></td>
                                                    <td>
                                                        Q.<?php echo display_formato_dinero($total_Camaras->avaluo_c) ?></td>
                                                    <td>
                                                        Q.<?php echo display_formato_dinero($total_Camaras->mutuo) ?></td>
                                                </tr>
                                                <tr>
                                                    <td>Celulares</td>
                                                    <td><?php echo $total_Celulares->numero ?></td>
                                                    <td>
                                                        Q.<?php echo display_formato_dinero($total_Celulares->avaluo_ce) ?></td>
                                                    <td>
                                                        Q.<?php echo display_formato_dinero($total_Celulares->avaluo_c) ?></td>
                                                    <td>
                                                        Q.<?php echo display_formato_dinero($total_Celulares->mutuo) ?></td>
                                                </tr>
                                                <tr>
                                                    <td>Computadoras Laptops y Tablets</td>
                                                    <td><?php echo $total_computadoras_laptops_tablets->numero ?></td>
                                                    <td>
                                                        Q.<?php echo display_formato_dinero($total_computadoras_laptops_tablets->avaluo_ce) ?></td>
                                                    <td>
                                                        Q.<?php echo display_formato_dinero($total_computadoras_laptops_tablets->avaluo_c) ?></td>
                                                    <td>
                                                        Q.<?php echo display_formato_dinero($total_computadoras_laptops_tablets->mutuo) ?></td>
                                                </tr>
                                                <tr>
                                                    <td>Deportes</td>
                                                    <td><?php echo $total_deportes->numero ?></td>
                                                    <td>
                                                        Q.<?php echo display_formato_dinero($total_deportes->avaluo_ce) ?></td>
                                                    <td>
                                                        Q.<?php echo display_formato_dinero($total_deportes->avaluo_c) ?></td>
                                                    <td>
                                                        Q.<?php echo display_formato_dinero($total_deportes->mutuo) ?></td>
                                                </tr>
                                                <tr>
                                                    <td>Electrodomésticos</td>
                                                    <td><?php echo $total_electrodomesticos->numero ?></td>
                                                    <td>
                                                        Q.<?php echo display_formato_dinero($total_electrodomesticos->avaluo_ce) ?></td>
                                                    <td>
                                                        Q.<?php echo display_formato_dinero($total_electrodomesticos->avaluo_c) ?></td>
                                                    <td>
                                                        Q.<?php echo display_formato_dinero($total_electrodomesticos->mutuo) ?></td>
                                                </tr>
                                                <tr>
                                                    <td>Herramientas</td>
                                                    <td><?php echo $total_herramientas->numero ?></td>
                                                    <td>
                                                        Q.<?php echo display_formato_dinero($total_herramientas->avaluo_ce) ?></td>
                                                    <td>
                                                        Q.<?php echo display_formato_dinero($total_herramientas->avaluo_c) ?></td>
                                                    <td>
                                                        Q.<?php echo display_formato_dinero($total_herramientas->mutuo) ?></td>
                                                </tr>
                                                <tr>
                                                    <td>Hogar</td>
                                                    <td><?php echo $total_hogar->numero ?></td>
                                                    <td>
                                                        Q.<?php echo display_formato_dinero($total_hogar->avaluo_ce) ?></td>
                                                    <td>
                                                        Q.<?php echo display_formato_dinero($total_hogar->avaluo_c) ?></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        Q.<?php echo display_formato_dinero($total_instrumentos_musicales->avaluo_ce) ?></td>
                                                    <td>
                                                        Q.<?php echo display_formato_dinero($total_instrumentos_musicales->avaluo_c) ?></td>
                                                    <td>
                                                        Q.<?php echo display_formato_dinero($total_instrumentos_musicales->mutuo) ?></td>
                                                </tr>
                                                <tr>
                                                    <td>Joyería</td>
                                                    <td><?php echo $total_joyeria->numero ?></td>
                                                    <td>
                                                        Q.<?php echo display_formato_dinero($total_joyeria->avaluo_ce) ?></td>
                                                    <td>
                                                        Q.<?php echo display_formato_dinero($total_joyeria->avaluo_c) ?></td>
                                                    <td>
                                                        Q.<?php echo display_formato_dinero($total_joyeria->mutuo) ?></td>
                                                </tr>
                                                <tr>
                                                    <td>Línea blanca</td>
                                                    <td><?php echo $total_line_blanca->numero ?></td>
                                                    <td>
                                                        Q.<?php echo display_formato_dinero($total_line_blanca->avaluo_ce) ?></td>
                                                    <td>
                                                        Q.<?php echo display_formato_dinero($total_line_blanca->avaluo_c) ?></td>
                                                    <td>
                                                        Q.<?php echo display_formato_dinero($total_line_blanca->mutuo) ?></td>
                                                </tr>
                                                <tr>
                                                    <td>Motocicletas y Automóviles</td>
                                                    <td><?php echo $total_instrumentos_musicales->numero ?></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        Q.<?php echo display_formato_dinero($total_salud_belleza->avaluo_ce) ?></td>
                                                    <td>
                                                        Q.<?php echo display_formato_dinero($total_salud_belleza->avaluo_c) ?></td>
                                                    <td>
                                                        Q.<?php echo display_formato_dinero($total_salud_belleza->mutuo) ?></td>
                                                </tr>
                                                <tr>
                                                    <td>Video</td>
                                                    <td><?php echo $total_video->numero ?></td>
                                                    <td>
                                                        Q.<?php echo display_formato_dinero($total_video->avaluo_ce) ?></td>
                                                    <td>
                                                        Q.<?php echo display_formato_dinero($total_video->avaluo_c) ?></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        Q.<?php echo display_formato_dinero($total_videojuegos->avaluo_ce) ?></td>
                                                    <td>
                                                        Q.<?php echo display_formato_dinero($total_videojuegos->avaluo_c) ?></td>
                                                    <td>
                                                        Q.<?php echo display_formato_dinero($total_videojuegos->mutuo) ?></td>
                                                </tr>
                                            </table>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <?php
                                        //tienda 5
                                        $productos_en_liquidacion_tienda_1_5 = $ci->Productos_model->get_productos_liquidacion_inventario('1', '5');
                                        $productos_en_liquidacion_tienda_2_5 = $ci->Productos_model->get_productos_liquidacion_inventario('2', '5');
                                        $productos_en_liquidacion_tienda_3_5 = $ci->Productos_model->get_productos_liquidacion_inventario('3', '5');
                                        $productos_en_liquidacion_tienda_4_5 = $ci->Productos_model->get_productos_liquidacion_inventario('4', '5');
                                        $productos_en_liquidacion_tienda_5_5 = $ci->Productos_model->get_productos_liquidacion_inventario('5', '5');
                                        $productos_en_liquidacion_tienda_6_5 = $ci->Productos_model->get_productos_liquidacion_inventario('6', '5');
                                        ?>
                                        <div class="col-md-12">
                                            <div class="table-responsive">
                                                <table class="table table-bordered table-hover" id="tienda_5">
                                                    <thead>
                                                    <tr>
                                                        <th>#</th>
                                                        <th>Id</th>
